...
class ReleasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create release" do
    assert_difference('Release.count') do
      post releases_url, params: { release: { project: @release.project, version: @release.version } }, as: :json
    end
  ...
  test "should update release" do
    patch release_url(@release), params: { release: { project: @release.project, version: @release.version } }, as: :json
    assert_response 200
  end
